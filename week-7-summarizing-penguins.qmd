...
```{r}
penguins |>
  mutate(bill_ratio = ___________,
         body_mass_kg = ___________,
         flipper_length_m = ______________)
```
...
```{r}
penguins |> 
  _________(body_mass_kg = ____________) |> 
